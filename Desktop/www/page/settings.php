...
?>
<section class="container wrapper py-lg-5 sm"
    ...
    <form method="POST"
        ...
        <div class="row">
            ...
            <div class="form-group col">
                <label for="customRange2"
                    class="form-label">Share: <span id="percentage">50</span>%</label>
                <input type="range"
                    class="form-range"
                    min="1"
                    max="100"
        ...
        <div id="button"
            class="my-3 d-grid gap-2">
            <button class="btn btn-success btn-block "
                name="add">Add MikroTik</button>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-primary btn-sm text-center"
                                onclick="edit('<?= $MT[ 'name' ] ?>','<?= $MT[ 'ipaddress' ]; ?>','<?= $MT[ 'username' ]; ?>','<?= $MT[ 'port' ]; ?>','<?= $MT[ 'id' ]; ?>','<?= $MT[ 'currency' ]; ?>','<?= $MT[ 'interface' ]; ?>','<?= $MT[ 'share' ]; ?>')">Edit</i></button>
                            <button form="myform"
                                class="btn btn-danger btn-block btn-sm"
                                name="Remove"
                                value="<?= $MT[ 'id' ]; ?>">Remove</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
