...
$err = '';
if (isset($_POST['add'])) {
    if ($_POST['username'] != "" && $_POST['name'] != "" && $_POST['password'] != "" && $_POST['ipaddress'] != "" && $API->connect($_POST['ipaddress'], $_POST['username'], $_POST['password'], $_POST['port'])) {
        PDO_Execute(
            "INSERT INTO settings (id,name,ipaddress,username,password,port,currency,interface,share) 
                VALUES (:id,:name,:ipaddress,:username,:password,:port,:currency,:interface,:share)",
            array("id" => 1, "name" => $_POST['name'], "ipaddress" => $_POST['ipaddress'], "username" => $_POST['username'], "password" => $_POST['password'], "port" => $_POST['port'], "currency" => $_POST['currency'], "interface" => $_POST['interface'], "share" => $_POST['shared'])
        );
        header('location: ../index.php');
    } else {
