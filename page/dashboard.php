...
?>
  ...
  <div class="container py-2">
    <div class="row mt-2">
      ...
      <div class="col-xl col-md-6 mb-2">
        <div class="card bg-light shadow h-100 ">
          <div class="card-body">
            <div id="stats1" class="row no-gutters align-items-center">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-xl col-md-6 mb-2">
        <div class="card bg-light shadow h-100 ">
          <div class="card-body">
            <div id="usage" class="row no-gutters align-items-center">
            </div>
          </div>
        </div>
      </div>
      <div class="col-xl col-md-6 mb-2">
        <div class="card bg-light shadow h-100 ">
          <div class="card-body">
            <div id="stats2" class="row no-gutters align-items-center">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card-body">
            <form method="post" class="p-2">
              <ul class="pagination pagination-sm">
                <li>
                  <h3 class="text-center"><?= $interface ? $interface : $getinterface[0]['name'] ?></h3>
                </li>
                <li class="px-3">
                  <select name="interFace" class="form-control">
                    <option value="none" selected disabled hidden>Select Interface</option>
                    <?php
                    for ($i = 0; $i < count($getinterface); $i++) {
                      echo '<option value="' . $getinterface[$i]['name'] . '">' . $getinterface[$i]['name'] . '</option>';
                    }
                    ?>
                  </select>
                </li>
                <li>
                  <button class="btn btn-block btn-outline-primary" name="selectiface">Apply</button>
                </li>
              </ul>
            </form>
  ...
  <script type="text/javascript">
    var interface = "<?= $interface ? $interface : $getinterface[0]['name'] ?>";
